...
var port; //端口号
var hostname; //主机名
var DEFAULT_DEPLOY_KEY = 'deploy.default'; //定义常量
var async = require('async'); //加载async模块
...
exports = module.exports = function(opt, collection, total){
    ...
    //获取构建配置
    //参考 http://fis.baidu.com/docs/api/fis-conf.html#deploy
...
exports.MAX_TASK_SIZE = 5; //异步并行处理时，最大允许的并行个数（任务数）
