...
function visit562_212_2(result) {
...
function visit556_189_1(result) {
...
function visit555_177_3(result) {
...
function visit554_177_2(result) {
...
function visit551_174_1(result) {
...
function visit550_155_1(result) {
...
function visit549_148_1(result) {
...
function visit548_147_1(result) {
...
function visit547_118_2(result) {
...
function visit546_118_1(result) {
...
(function(S) {
  ...
  function normalizeArray(parts, allowAboveRoot) {
    ...
    if (visit535_36_1(allowAboveRoot)) {
  ...
  for (i = args.length - 1; visit536_65_1(visit537_65_2(i >= 0) && !absolute); i--) {
    _$jscoverage['/path.js'].lineData[66]++;
    path = args[i];
    _$jscoverage['/path.js'].lineData[67]++;
    if (visit538_67_1(visit539_67_2(typeof path !== 'string') || !path)) {
    ...
    absolute = visit540_71_1(path.charAt(0) === '/');
  }
  ...
  return visit541_78_1(((absolute ? '/' : '') + resolvedPathStr) || '.');
}, 
  normalize: function(path) {
  _$jscoverage['/path.js'].functionData[4]++;
  _$jscoverage['/path.js'].lineData[92]++;
  var absolute = visit542_92_1(path.charAt(0) === '/'), trailingSlash = visit543_93_1(path.slice(-1) === '/');
  ...
  if (visit544_99_1(!path && !absolute)) {
    _$jscoverage['/path.js'].lineData[100]++;
    path = '.';
  }
  _$jscoverage['/path.js'].lineData[103]++;
  if (visit545_103_1(path && trailingSlash)) {
  ...
  return visit546_118_1(p && (visit547_118_2(typeof p === 'string')));
}).join('/'));
}, 
  ...
  for (sameIndex = 0; visit548_147_1(sameIndex < commonLength); sameIndex++) {
    _$jscoverage['/path.js'].lineData[148]++;
    if (visit549_148_1(fromParts[sameIndex] !== toParts[sameIndex])) {
  ...
  while (visit550_155_1(sameIndex < fromParts.length)) {
  ...
  var result = visit551_174_1(path.match(splitPathRe) || []), basename;
  _$jscoverage['/path.js'].lineData[176]++;
  basename = visit552_176_1(result[3] || '');
  _$jscoverage['/path.js'].lineData[177]++;
  if (visit553_177_1(ext && visit554_177_2(basename && visit555_177_3(basename.slice(-1 * ext.length) === ext)))) {
  ...
  var result = visit556_189_1(path.match(splitPathRe) || []), root = visit557_190_1(result[1] || ''), dir = visit558_191_1(result[2] || '');
  _$jscoverage['/path.js'].lineData[193]++;
  if (visit559_193_1(!root && !dir)) {
    _$jscoverage['/path.js'].lineData[195]++;
    return '.';
  }
  _$jscoverage['/path.js'].lineData[198]++;
  if (visit560_198_1(dir)) {
  ...
  return visit561_212_1((visit562_212_2(path.match(splitPathRe) || []))[4] || '');
}};
})(KISSY);
