...
function visit604_378_1(result) {
...
function visit603_356_1(result) {
...
function visit602_353_1(result) {
...
function visit601_345_2(result) {
...
function visit596_333_1(result) {
...
function visit593_321_1(result) {
...
function visit592_316_1(result) {
...
function visit591_314_1(result) {
...
function visit590_296_1(result) {
...
function visit589_290_1(result) {
...
function visit588_285_1(result) {
...
function visit587_282_1(result) {
...
function visit586_278_1(result) {
...
function visit579_244_1(result) {
...
function visit578_239_1(result) {
...
function visit577_235_1(result) {
...
function visit576_231_1(result) {
...
function visit575_228_1(result) {
...
function visit570_195_1(result) {
...
(function(S, undefined) {
  ...
  var win = S.Env.host, doc = win.document, navigator = win.navigator, ua = visit563_11_1(visit564_11_2(navigator && navigator.userAgent) || '');
  ...
  function setTridentVersion(ua, UA) {
    ...
    if (visit566_26_1((m = ua.match(/Trident\/([\d.]*)/)) && m[1])) {
  ...
  function getIEVersion(ua) {
    ...
    if (visit567_35_1((m = ua.match(/MSIE ([^;]*)|Trident.*; rv(?:\s|:)?([0-9.]+)/)) && (v = (visit568_36_1(m[1] || m[2]))))) {
  ...
  function getDescriptorFromUserAgent(ua) {
    ...
    var EMPTY = '', os, core = EMPTY, shell = EMPTY, m, IE_DETECT_RANGE = [6, 9], ieVersion, v, end, VERSION_PLACEHOLDER = '{{version}}', IE_DETECT_TPL = '<!--[if IE ' + VERSION_PLACEHOLDER + ']><' + 's></s><![endif]-->', div = visit569_53_1(doc && doc.createElement('div')), s = [];
  ...
  nodejs: undefined};
    ...
    if (visit570_195_1(div && div.getElementsByTagName)) {
    ...
    UA.core = visit599_343_1(UA.core || core);
    _$jscoverage['/ua.js'].lineData[344]++;
    UA.shell = shell;
    _$jscoverage['/ua.js'].lineData[345]++;
    UA.ieMode = visit600_345_1(visit601_345_2(UA.ie && doc.documentMode) || UA.ie);
  ...
  if (visit602_353_1(typeof process === 'object')) {
    _$jscoverage['/ua.js'].lineData[354]++;
    var versions, nodeVersion;
    _$jscoverage['/ua.js'].lineData[356]++;
    if (visit603_356_1((versions = process.versions) && (nodeVersion = versions.node))) {
  ...
  var browsers = ['webkit', 'trident', 'gecko', 'presto', 'chrome', 'safari', 'firefox', 'ie', 'opera'], documentElement = visit604_378_1(doc && doc.documentElement), className = '';
  _$jscoverage['/ua.js'].lineData[380]++;
  if (visit605_380_1(documentElement)) {
  ...
  if (visit606_383_1(v)) {
    ...
    if (visit607_388_1(S.trim(className))) {
