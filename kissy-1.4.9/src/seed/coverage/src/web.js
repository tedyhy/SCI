...
function visit673_241_1(result) {
...
function visit672_231_3(result) {
...
function visit671_231_2(result) {
...
function visit670_231_1(result) {
...
function visit669_215_1(result) {
...
function visit668_209_1(result) {
...
function visit667_206_1(result) {
...
function visit666_193_1(result) {
...
function visit665_182_1(result) {
...
function visit664_173_2(result) {
...
(function(S, undefined) {
  ...
  var win = S.Env.host, UA = S.UA, doc = win.document, docElem = visit644_12_1(doc && doc.documentElement), location = win.location, EMPTY = '', domReady = 0, callbacks = [], POLL_RETIRES = 500, POLL_INTERVAL = 40, RE_ID_STR = /^#?([\w-]+)$/, RE_NOT_WHITESPACE = /\S/, standardEventModel = !!(visit645_24_1(doc && doc.addEventListener)), DOM_READY_EVENT = 'DOMContentLoaded', READY_STATE_CHANGE_EVENT = 'readystatechange', LOAD_EVENT = 'load', COMPLETE = 'complete', addEventListener = standardEventModel ? function(el, type, fn) {
  ...
  return visit646_48_1(visit647_48_2(obj != null) && visit648_48_3(obj == obj.window));
}, 
  parseXML: function(data) {
  _$jscoverage['/web.js'].functionData[6]++;
  _$jscoverage['/web.js'].lineData[58]++;
  if (visit649_58_1(data.documentElement)) {
  ...
  try {
    ...
    if (visit650_64_1(win.DOMParser)) {
  ...
  if (visit651_77_1(!xml || visit652_77_2(!xml.documentElement || xml.getElementsByTagName('parsererror').length))) {
  ...
  if (visit653_88_1(data && RE_NOT_WHITESPACE.test(data))) {
    _$jscoverage['/web.js'].lineData[92]++;
    if (visit654_92_1(win.execScript)) {
  ...
  S.log(visit656_113_1(e.stack || e), 'error');
  ...
  if (visit657_134_1(++retryCount > POLL_RETIRES)) {
  ...
  function fireReady() {
    ...
    for (var i = 0; visit661_156_1(i < callbacks.length); i++) {
  ...
  S.log(visit662_160_1(e.stack || e), 'error');
  ...
  function bindReady() {
    ...
    if (visit663_173_1(!doc || visit664_173_2(doc.readyState === COMPLETE))) {
    ...
    if (visit665_182_1(standardEventModel)) {
  ...
  if (visit666_193_1(doc.readyState === COMPLETE)) {
    ...
    fireReady();
      ...
      var notframe, doScroll = visit667_206_1(docElem && docElem.doScroll);
      _$jscoverage['/web.js'].lineData[208]++;
      try {
        _$jscoverage['/web.js'].lineData[209]++;
        notframe = (visit668_209_1(win.frameElement === null));
      }      catch (e) {
  _$jscoverage['/web.js'].lineData[211]++;
  notframe = false;
}
      _$jscoverage['/web.js'].lineData[215]++;
      if (visit669_215_1(doScroll && notframe)) {
  ...
  if (visit670_231_1(location && visit671_231_2((visit672_231_3(location.search || EMPTY)).indexOf('ks-debug') !== -1))) {
